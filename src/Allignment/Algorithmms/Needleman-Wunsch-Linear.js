...
function getCoordinates(matchScore, mismatchScore, gapScore, substitutionsMatrix, seq1, seq2, seq1Start, seq1End, seq2Start, seq2End) {
  ...
  if (rowLength === 1) {
    ...
    return ([...getCoordinates(matchScore, mismatchScore, gapScore, seq1, seq2, seq1Start, m, seq2Start, scores[scores.length - 1]), ...getCoordinates(matchScore, mismatchScore, gapScore, seq1, seq2, m, seq1End, scores[scores.length - 1], seq2End)]);
  }
}
